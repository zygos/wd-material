...
import { articleFactory, articleMatcher } from './utils';
...
describe('create', () => {
  ...
  it('should create an article (with factory functions)', async () => {
    // same as the test above, but using factory functions
    // ACT (When we call...)
    const article = await repository.create(articleFactory());
...
describe('update', () => {
  it('should update an article', async () => {
    ...
    const [article] = await createArticles(articleFactory());
