...
describe('GET', () => {
  ...
  it('should return a list of existing articles', async () => {
    ...
    //     title: 'My Title', // our default title, content generated by articleFactory
...
describe('POST', () => {
  it('should return 400 if title is missing', async () => {
    ...
    const { body } = await supertest(app)
      .post('/articles')
      .send(omit(['title'], articleFactory({})))
  ...
  it('should return 400 if content is missing', async () => {
    ...
    const { body } = await supertest(app)
      .post('/articles')
      .send(omit(['content'], articleFactory({})))
      .expect(400);
...
describe('PATCH /:id', () => {
  ...
  it('persists changes', async () => {
    const id = 41512;
    await createArticles([articleFactory({ id })]);
