...
export const spreadsheetParser = z.object(spreadsheetSchema).strict()

export const exportColumnOrder = Object.keys(
  spreadsheetSchema,
) as (keyof typeof spreadsheetSchema)[]

export type Spreadsheet = z.infer<typeof spreadsheetParser>
