...
export const sendSignupEmail = sendUserEmail(
  (user) => `Welcome, ${user.name}! We are glad to have you on board.`,
)

export const sendResetPasswordEmail = sendUserEmail(
  (user) => `Hi, ${user.name}! You can reset your password here.`,
)

export const sendPasswordChangedEmail = sendUserEmail(
